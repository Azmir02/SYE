...
const Story = () => {
  ...
  return (
    <div className='relative'>
        <div className='grid grid-cols-5 lg:grid-cols-[repeat(6,1fr)] gap-1 justify-between items-center'>
            <div className='relative bg-white rounded-md group cursor-pointer shadow-[0px_24px_50px_rgba(0,_0,_0,_0.1)] h-[190px]'>
                <div className='w-full overflow-hidden rounded-tr-md rounded-tl-md h-[130px]'>
                    <img className='group-hover:scale-[1.02] transition-all ease-linear duration-300 w-full h-full object-cover' src="../../../images/default_pic.png" alt="default" />
                </div>
            ...
            stories.slice(0 , max).map((item,index)=>(
                <div key={index} className='relative rounded-md group cursor-pointer shadow-[0px_24px_50px_rgba(0,_0,_0,_0.1)] overflow-hidden'>
