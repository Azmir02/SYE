  ...
  return (
    <div>
      <div className="relative group h-[190px] ">
        ...
        <img
          className="w-full h-full object-cover group-hover:scale-[1.02] transition-all ease-linear duration-150"
          src={image}
          alt="images"
        />
        <span className="absolute hidden md:block bottom-[10px] left-[5px] text-base font-primary font-regular text-white z-10 leading-[16px]">
          {profile_name}
        </span>
