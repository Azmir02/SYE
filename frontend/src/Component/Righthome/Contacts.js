...
const Contacts = () => {
  ...
  return (
    <div className='bg-white rounded-md shadow-[0px_24px_50px_rgba(0,_0,_0,_0.1)] px-5 py-4 mt-3 sticky top-[75px] left-0 overflow-y-auto h-[690px]'>
        <div className='flex items-center justify-between'>
            <h3 className='text-base font-primary font-medium text-black w-[80px]'>Contacts</h3>
