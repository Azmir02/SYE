...
const MenuOption = () => {
  ...
  return (
    <div className="main_menu w-[307px] lg:w-[750px] h-[90vh] bg-[#F7F8FA] rounded-md shadow-[-3px_4px_12px_0px_rgba(219,219,219,0.75)] p-5 box-border">
      ...
      <div className=" main-menu grid grid-cols-1 md:grid-cols-[1.7fr_1fr] gap-4 mt-5 overflow-y-auto  h-[95%] select-none">
        <div className="left bg-white w-full rounded-md p-6 hidden md:block">
          <div
            className="flex items-center bg-[#F0F2F5] px-4 py-2 rounded-full"
            onClick={() => {
          ...
          >
            ...
            <input
              type="text"
              className="focus:outline-none w-[90%] ml-2 bg-[#F0F2F5] font-primary text-base"
              placeholder="Search"
              ref={focused}
            />
          </div>
          <div className="mt-4 border-b border-solid border-[#d3d3d3]">
            <h2 className="font-primary text-2xl text-black font-bold pl-4">
              Social
            </h2>
          ...
          <div className="mt-4 border-b border-solid border-[#d3d3d3]">
            {creat.slice(0, 3).map((item, i) => (
              ...
              >
                ...
                <div className="w-[71%]">
                  <h5 className="font-primary text-base text-black font-medium">
                    {item.title}
                  </h5>
                </div>
              </div>
