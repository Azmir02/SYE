...
const Profile = ({user}) => {
  return (
    <div className='w-[330px] bg-white p-5 rounded-md shadow-[0px_24px_50px_rgba(0,_0,_0,_0.1)]'>
        <Link to="/profile" className='flex items-center relative after:absolute after:bottom-0 after:left-0 after:content[] after:bg-[#d3d3d3] after:w-[290px] after:h-[1px] pb-3'>
