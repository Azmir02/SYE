...
const Usermenu = ({ user }) => {
  ...
  return (
    <div className="w-[300px] md:w-[360px] bg-white p-3 md:p-7 relative rounded-md shadow-[0px_24px_50px_rgba(0,_0,_0,_0.1)]">
      {visible === 0 && (
        <>
          ...
          <div className="mt-[160px] cursor-pointer">
            <div className="flex items-center justify-between border-b border-solid border-[#d3d3d3] pb-3">
              ...
              <div className="ml-3 w-[250px]">
                <p className="font-primary text-lg font-medium leading-[0.8]">
                  Give Feedback
                </p>
                <span className="font-primary text-sm text-secondary_color">
                  Help us improve SYE
                </span>
              </div>
            </div>
