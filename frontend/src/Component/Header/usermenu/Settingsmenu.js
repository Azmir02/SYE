  ...
  return (
    <>
      <div className="flex items-center justify-between px-1">
        ...
        <div className="w-[80%]">
          <h3 className="font-primary text-text_color text-2xl font-bold">
            Settings & Privacy
          </h3>
        </div>
      </div>

      <div className="flex items-center justify-between mt-5 mb-2 cursor-pointer hover:bg-hover_clr p-2 rounded-md transition-all duration-200 ease-linear">
      ...
      <div className="flex items-center justify-between my-2 cursor-pointer hover:bg-hover_clr p-2 rounded-md transition-all duration-200 ease-linear">
        <div className="w-[40px] h-[40px] rounded-full bg-page_color flex items-center justify-center">
