    ...
    <div className="heading flex justify-between items-center px-4 py-5 shadow-[0px_24px_50px_rgba(0,_0,_0,_0.1)] fixed top-0 left-0 w-full">
       <div className="left-part w-[320px] flex justify-between items-center relative">
        ...
        <div className="search flex items-center bg-[#F0F2F5] px-4 py-2 rounded-full" onClick={()=>{setShow(true)}}>
            <Search color="#65676B"/>
            <input type="text" className='focus:outline-none ml-2 bg-[#F0F2F5] font-primary text-base' placeholder='Search' onClick={()=>{setShow(true)}}/>
        </div>
       ...
       <div>
        ...
        <div className='relative' ref={usermenuClick}>
            <div onClick={()=>{setUsermenu((prev)=>!prev)}} className="flex items-center justify-between bg-[#F1F4F7] rounded-full px-4 py-2 cursor-pointer">
