        ...
        <div className='border-y border-solid border-[#EEF0F3] mt-3 py-3'>
          <div className='px-5 grid grid-cols-2'>
            <div className='text-center relative after:content[] after:absolute after:top-0 after:right-0 after:w-[2px] after:h-[50px] after:bg-[#EEF0F3]'>
              <h4 className='font-primary text-lg font-medium text-black'>6,664</h4>
              <p className='font-primary text-sm font-regular text-secondary_color'>Following</p>
            </div>

            <div className='text-center'>
              <h4 className='font-primary text-lg font-medium text-black'>9,991</h4>
              <p className='font-primary text-sm font-regular text-secondary_color'>Followers</p>
            </div>
          </div>
        </div>
