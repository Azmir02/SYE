...
const Leftoption = () => {
  ...
  return (
    <div className="mt-3 w-[265px] 3xl:w-full">
      <div className="bg-white rounded-md shadow-[0px_24px_50px_rgba(0,_0,_0,_0.1)] px-0 2xl:px-5 py-4 overflow-y-auto h-[390px] main-menu">
        ...
        {!visible && (
          ...
          >
            ...
            <div className="ml-3">
              <span className="font-primary text-black font-semibold text-base">
                Show More
              </span>
            </div>
          </div>
