  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-main_bg relative">
      ...
      <form className="w-[350px]" onSubmit={formik.handleSubmit}>
        ...
        <input
          className="w-full p-3 rounded-md bg-secondary_bg font-primary text-sm focus:outline-0 text-white mb-5"
          type="email"
          placeholder="Email"
          autoComplete="off"
          name="email"
        ...
        <div className="text-center">
          <Link
            className="text-blue hover:underline font-primary text-base font-normal"
            to="/reset"
          >
            Forgotten password ?
          </Link>
        ...
        <div className="text-center">
          <button
            className="bg-primary_color px-8 py-3 mt-5 rounded-md font-primary font-normal text-base transition ease-linear duration-150 hover:shadow-[0px_0px_27px_rgba(80,_147,_243,_0.72)] text-white"
            type="submit"
          >
            Sign In
          </button>
        ...
        <p className="singin text-white font-primary text-lg mt-7 text-center">
